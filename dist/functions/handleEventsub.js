...
const eventsub_1 = require("../classes/eventsub");
function eventsub(type, data) {
    return __awaiter(this, void 0, void 0, function* () {
        switch (type) {
            ...
            case "channel.subscribe":
                eventsub_1.EventSubHandler.handleChannelSubscription(data);
                break;
            ...
            case "channel.channel_points_custom_reward.remove":
                // Handle channel points custom reward remove subscription
                break;
            case "channel.channel_points_custom_reward_redemption.add":
                // Handle channel points custom reward redemption add subscription
                eventsub_1.EventSubHandler.handleChannelPointsCustomRewardAdd(data);
                break;
